...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('deploy_ik.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('deploy_ik.wasm', import.meta.url).href;
}
...
var _deploy_ik_solve = Module['_deploy_ik_solve'] = createExportWrapper('deploy_ik_solve', 6);
var _deploy_fk = Module['_deploy_fk'] = createExportWrapper('deploy_fk', 4);
